...
function Division3() {
  ...
  useSEO('Division Three | Acme Labs', 'Learn about our research division.', 'https://example.com/division-3');
  ...
  return (
    <div ref={container}>
      <section className="page-hero" aria-label="Division Three">
        <div className="page-hero-bg" aria-hidden="true" />
        <div className="page-hero-layout">
          <div className="page-hero-left">
            <div className="page-hero-status">[ DIVISION: RESEARCH ]</div>
            <h1 style={{ marginTop: 16 }}>RESEARCH<br />DIVISION.</h1>
            <p className="page-hero-desc" style={{ maxWidth: '48ch' }}>
              Translating scientific breakthroughs into practical,
              deployable technology across multiple domains.
            </p>
