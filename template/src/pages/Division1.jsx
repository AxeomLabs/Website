...
function Division1() {
  ...
  useSEO('Division One | Acme Labs', 'Learn about our engineering division.', 'https://example.com/division-1');
  ...
  return (
    <div ref={container}>
      <section className="page-hero" aria-label="Division One">
        <div className="page-hero-bg" aria-hidden="true" />
        <div className="page-hero-layout">
          <div className="page-hero-left">
            <div className="page-hero-status">[ DIVISION: ENGINEERING ]</div>
            <h1 style={{ marginTop: 16 }}>ENGINEERING<br />DIVISION.</h1>
            <p className="page-hero-desc" style={{ maxWidth: '48ch' }}>
              Building products from concept to production — hardware, firmware,
              and full-stack software under one roof.
            </p>
